...
public class InitDAO {
	...
	public void init() {
		...
		em.createNativeQuery("create table if not exists utilisateur (\r\n"
				+ "	id int not null,\r\n"
		...
		em.createNativeQuery("create table if not exists enseignant (\r\n"
				+ "	id int not null,\r\n"
				+ "	nom varchar(50) not null,\r\n"
				+ "	prenom varchar(50) not null,\r\n"
				+ "	email varchar(100) not null,\r\n"
		...
		em.createNativeQuery("create table if not exists departement (\r\n"
				+ "	id int not null,\r\n"
				+ "	nom varchar(50) not null,\r\n"
		...
		em.createNativeQuery("create table if not exists section (\r\n"
				+ "	id int not null,\r\n"
				+ "	departement varchar(20) not null,\r\n"
				+ "	nom varchar(50) not null,\r\n"
				+ "	missions varchar(100) not null,\r\n"
		...
		em.createNativeQuery("create table if not exists ue (\r\n"
				+ "	id int not null,\r\n"
		...
		em.createNativeQuery("create table if not exists aa (\r\n"
				+ "	id int not null,\r\n"
				+ "	anneeAcademique int not null,\r\n"
		...
		em.createNativeQuery("create table if not exists mission (\r\n"
				+ "	id int not null,\r\n"
		...
		em.createNativeQuery("create table if not exists attribution (\r\n"
				+ "	id int not null,\r\n"
				+ "	anneeAcademique varchar(50) not null,\r\n"
